...
const emptyProduct = { name: '', category: '', price: 0, cost: 0, description: '' };
...
export default function Products() {
  ...
  const openEdit = (p: Product) => { setEditing(p); setForm({ name: p.name, category: p.category, price: p.price, cost: p.cost, description: p.description }); setDialogOpen(true); };
